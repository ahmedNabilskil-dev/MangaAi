          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Section icon={CreditCard} title="3. Use of Services">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Share or resell access to your account or API keys.</li>
              </ul>

              <h3 className="text-xl font-bold text-pink-400 mb-3 mt-6">
                3.3 API Keys & Third-Party Services
              </h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  You are responsible for providing your own API keys for
                  third-party AI services (e.g., Google Gemini, OpenAI).
                </li>
                <li>
                  Your API keys are stored encrypted in our Supabase database
                  and are used solely to connect to AI services on your behalf.
                </li>
                <li>
                  You must comply with the terms of service of third-party AI
                  providers (Gemini, GPT, etc.).
                </li>
                <li>
            ...
            <Section icon={Copyright} title="4. Intellectual Property">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Content generated by AI models (Gemini, GPT, custom models)
                  may be subject to the terms of the AI provider.
                </li>
                <li>
            ...
            <Section icon={CreditCard} title="5. API Keys & AI Usage">
              <h3 className="text-xl font-bold text-pink-400 mb-3">
                5.1 Your API Keys
              </h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Kemtoon Studio allows you to use your own AI service API keys
                  (e.g., Google Gemini, OpenAI) to generate manga content.
                </li>
                <li>
                  You are responsible for obtaining and maintaining your API
                  keys and for any costs associated with their usage.
                </li>
                <li>
                  Your API keys are stored encrypted in our secure database. We
                  never share, sell, or use your API keys for any purpose other
                  than making requests on your behalf.
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Kemtoon is currently free to use. You only pay for the AI
                  services you consume through your own API keys.
                </li>
                <li>
            ...
            <Section icon={AlertTriangle} title="6. Disclaimers & Limitations">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Kemtoon integrates with third-party AI services (Gemini, GPT,
                  etc.). We are not responsible for their performance, downtime,
                  or policy changes.
                </li>
                <li>
            ...
            <Section icon={Users} title="12. Contact Us">
              ...
              <div className="mt-4 p-6 bg-pink-900/30 border-2 border-pink-500 rounded-lg">
                ...
                <p>
                  <strong>Email:</strong>{" "}
                  <a
                    href="mailto:support@kemtoon.com"
